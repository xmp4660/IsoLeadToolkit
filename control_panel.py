...
- panel_utils.py: Utility methods (translation, UI helpers)
- panel_handlers.py: Core event handlers
- panel_dialogs.py: Dialog windows
- panel_export.py: Data export functionality
- panel_tabs/: Tab-specific builders (settings, algorithm, tools, style, legend, geochemistry)
"""
...
# Import Mixins
from panel_utils import PanelUtilsMixin
from panel_handlers import PanelHandlersMixin
from panel_dialogs import PanelDialogsMixin
from panel_export import PanelExportMixin
from panel_tabs import (
    SettingsTabMixin,
    AlgorithmTabMixin,
    ToolsTabMixin,
    StyleTabMixin,
